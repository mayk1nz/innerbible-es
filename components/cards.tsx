...
const DEAL_COPY: Record<UpsellId, { title: string; cta: string }> = {
  upsell1: { title: 'Toda la Biblia en audio, en orden cronológico', cta: 'Quiero escuchar la Biblia' },
  upsell2: { title: 'Tu Consejero + 3 planes de 90 días', cta: 'Quiero Palabras del Señor' },
}
