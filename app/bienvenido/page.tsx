...
export const metadata = { title: 'Gracias por tu compra', robots: { index: false, follow: false } }
  ...
  return (
    <main className="grid min-h-dvh place-items-center px-5 py-10">
      <div className="w-full max-w-[420px] rounded-[28px] border border-line bg-surface px-6 py-8 text-center shadow-card">
        ...
        <h1 className="mt-5 font-serif text-[28px] font-semibold leading-tight text-ink">¡Gracias por tu compra!</h1>
        <p className="mt-3 text-[16.5px] leading-relaxed text-text">
          En unos minutos recibirás un correo con la confirmación. Tu acceso está en la app de {APP.name}.
        </p>
        <div className="mt-6 rounded-2xl bg-gold-soft/60 p-4 text-left">
          <p className="flex gap-3 text-[15.5px] leading-snug text-ink">
            ...
            Entra con el <strong>mismo correo</strong> que usaste en la compra.
          </p>
        </div>
        <Link href="/login" className={`${buttonClass.primary} mt-6 min-h-14 text-[17px]`}>
          Entrar a la app
          <Icon name="arrowRight" className="size-5 text-gold-bright" />
        </Link>
        <p className="mt-5 text-[14px] text-muted">
          ¿No te llegó el correo? Revisa la carpeta de spam o escríbenos a{' '}
